...
#pragma region Class4
	...
	void CreateTextureImage()
	{
		...
		CreatImage(texWidth, texHeight, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, textureImage, textureImageMemory);
	...
	void CreatImage(uint32_t width, uint32_t height, VkFormat format, 
...
#pragma region Class5
	void CreateDepthResource()
	{
		...
		CreatImage(swapChainExtent.width, swapChainExtent.height, depthFormat, VK_IMAGE_TILING_OPTIMAL,
