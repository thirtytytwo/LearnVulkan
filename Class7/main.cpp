...
#pragma region Class 0-1
	...
	void CreateFramebuffers()
	{
		...
		{
			std::array<VkImageView, 2> attachments = { swapChainImageViews[i], depthImgaeView };
...
#pragma region Class4
	...
	void CreateTextureImage()
	{
		...
		CreatImage(texWidth, texHeight, mipLevels, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_TRANSFER_SRC_BIT| VK_IMAGE_USAGE_SAMPLED_BIT, 
	...
	void CreatImage(uint32_t width, uint32_t height, int32_t mipLevel,VkFormat format, 
...
#pragma region Class5
	void CreateDepthResource()
	{
		...
		CreatImage(swapChainExtent.width, swapChainExtent.height, 1, depthFormat, VK_IMAGE_TILING_OPTIMAL,
